      ...
      <div className="container">
        ...
        <div className="benefits-stat-card">
          ...
          <p className="benefits-stat-desc">
            Empresa de antecipação de FGTS e crédito há mais de 7 anos no
            mercado. Especialistas em consultoria financeira com atendimento de
            qualidade, transparência e credibilidade.
          </p>
        ...
        <div className="benefits-stat-cta">
